!  dll_verifica_nodo.for 
!
!  FUNCTIONS/SUBROUTINES exported from DLL_VERIFICA_NODO.dll:


!	DLL_VERIFICA_NODO_RIDOTTO      - subroutine 
!
      subroutine dll_verifica_nodo_ridotto(                    
     *           lun_GUID,								 !lunghezza 	
...
c     *           n_warn,cod_warn,pt_warn_m,pt_warn_v) 
     *           n_warn,cod_warn,pt_warn_m,pt_warn_v,ier_dim) 
...
C***************************************************************************************************   
  ...
  ! Body of DLL_VERIFICA_NODO_RIDOTTO

      call controlla_dimensioni
     *             (num_pu_ns,num_cl_ns,num_lg_ns,num_ass_cl_ns,ier_dim)

	if (ier_dim.gt.0) return

c------>crea il file di input per il debug del codice
c      call scrivi_dati(                    
...
c-------------------------------------------------------------------------->output
	...
	return
	end !subroutine DLL_VERIFICA_NODO_RIDOTTO
c-------------------------------------------------------------------------------------------------
